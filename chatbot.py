...
1. WEBSITE PRIMACY: The retrieved context contains snippets marked as [SOURCE: LIVE WEBSITE] and [SOURCE: DOCUMENT PDF].
...
2. COMPREHENSIVE LISTING MANDATE (ZERO OMISSION):
...
Answer:"""
    ...
    try:
        ...
        traceback.print_exc()
        answer_text = "I am experiencing difficulty retrieving the information right now. Please try again."
