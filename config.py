...
# Simplified System Message that supports RAG Context
...
4. If information is truly not in the context, guide the user to visit https://aehsasfoundation.com/contact-us.
""")
